 ...
 *                                                                        *
 *  SETUP-CORE is free software: you can redistribute it and/or modify    *
...
public class VersionSettings {
	...
	protected static String ORG = "fr.cnrs.iees.tw-setup";

	/** The name of the ivy module (this will be the name of the generated jar file for
	 * dependent projects).*/
	protected static String MODULE = "tw-setup";
	...
	protected static String DESCRIPTION =
		"This module is specifically for generating the dependency file for 3Worlds: tw-dep.jar.";
